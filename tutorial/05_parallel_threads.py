...
def process_image():
    ...
    while running:
        ...
        if max_val >= threshold:
            ...
            #cv2.imshow("Pattern Matching", img_color)
            ...
            # 5 Sekunden pausieren, damit kein Spam passiert
            #time.sleep(5)
...
def mouse_action():
    """Bewegt die Maus zum gefundenen Match, klickt und drückt eine Taste."""
